...
<main>
	<div>
		...
		<form
			use:enhance={{ done, error }}
			action="https://usebasin.com/f/d5fbba0eef70"
			method="POST"
			class="mt-8 max-w-sm mx-auto p-3 border dark:border-neutral-800 rounded"
		>
			<div>
			...
			<div>
				...
				<textarea required name="message" id="" cols="30" rows="4" />
			</div>
